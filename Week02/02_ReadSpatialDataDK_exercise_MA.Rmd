...
Forests has 32, parks has 47, playgrounds has 51 and shelters has 19. 

Forest and parks are multipolygon - playgrounds and shelters are points.

2. What is the CRS value in these objects?
ETRS89: Forests, Parks, Shelters.
NA: Playgrounds.
...
over5ha <- parks %>% 
  dplyr::filter(areal_m2 > 50000) # 50.000 m2 is 5 ha
...
big_forests <- forests %>% 
  dplyr::filter(unclass(areas) > 200000)
...
plot(forests_geo, col = "blue");plot(parks$geometry, col = "pink", add = TRUE)
...
3334 x 3334 x 5. They represent the number of squares the raster is separated into. The 5 are the number of bands
