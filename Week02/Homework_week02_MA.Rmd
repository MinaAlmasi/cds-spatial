...
SRTM:(https://mhallwor.github.io/_pages/basics_Rasters)
Raster data (raster layer)
* Has 457 rows, 465 columns, 212500 cells in total. 
* Extent: Ranges from -113 to -113 longtitude and 37 to 37 latitude (weird??)
* coordinate reference (WGS84: world standard datum)
