...
monuments <- read_sf("Week04/fortidsminder/anlaeg_all_25832.shp")
...
parks[cont,] 
```
We want all the columns, but only the rows which are to be found within the buffer of the Nobel Park. 
